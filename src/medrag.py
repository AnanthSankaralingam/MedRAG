...
import sys
sys.path.append("src")
from .utils import RetrievalSystem, DocExtracter # Add a dot (.) before utils to import from the current directory
...
class MedRAG:
    ...
    def __init__(self, llm_name="OpenAI/gpt-4o", rag=True, follow_up=False, retriever_name="MedCPT", corpus_name="PatientData", db_dir="./corpus", cache_dir=None, corpus_cache=False, HNSW=False):
